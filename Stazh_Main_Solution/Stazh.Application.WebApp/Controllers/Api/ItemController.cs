...
namespace Stazh.Application.WebApp.Controllers.Api
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> Upload(IFormCollection data)
        {
            ...
            item.Name = data["Name"];
            item.Parent = _itemService.FindParentFromName(data["parentItem"]);
            item.Created = DateTime.UtcNow;
           
            item.ItemAttachments = new HashSet<Attachment>();
